...
UUID = os.environ.get('UUID', 'f44fd847-3b1f-4498-9528-d1ca58ca4f76')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'altare.lsdxch.dpdns.org')        # Argo固定隧道域名,留空即使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiMTE3ZTYwN2QwMGE3YmRjOTZiNTQwM2NiZTYzZjRmZGIiLCJ0IjoiYWNmNGRiMGQtMjVhOS00NjYxLWIxMTctYTQzZjRiZTMyZDAyIiwicyI6Ik9XTm1OVGRpTmprdFpUZGhNQzAwTldZekxUazJaR1V0WlRoa1l6Z3lOR0l4TnpjNSJ9')            # Argo固定隧道密钥,留空即使用临时隧道
...
NAME = os.environ.get('NAME', 'altare')                      # 节点名称
